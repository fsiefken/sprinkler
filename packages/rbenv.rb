...
package :symlink_rubies do
  ...
  runner "ln -s /opt/ruby-1.9.2-p290 /home/#{DEPLOY_USER}/.rbenv/versions/1.9.3-p194"
...
package :set_default_ruby do
  ...
  verify do
    file_contains "/home/#{DEPLOY_USER}/.rbenv/global", '1.9.3-p194'
  end
end
...
package :add_rbenv_bundler do
  ...
  runner "/home/#{DEPLOY_USER}/.rbenv/versions/1.9.3-p194/bin/gem install bundler"
  runner "/home/#{DEPLOY_USER}/.rbenv/bin/rbenv rehash"
  
  verify do 
    @commands << "/home/#{DEPLOY_USER}/.rbenv/versions/1.9.3-p194/bin/gem list | grep bundler"
  end
end
